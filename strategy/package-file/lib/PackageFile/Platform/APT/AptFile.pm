package PackageFile::Platform::APT::AptFile;
# ABSTRACT: Uses apt-file to retrieve packages and files
...
sub extract {
	...
	open(my $apt_file_output, '-|',
		qw{apt-file list --stream-results -x ^})
			or die "Cannot run apt-file: $!";
